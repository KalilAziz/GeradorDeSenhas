...
module.exports = {
    mode: 'development', //Temos dois mode`s, o development gera um arquivo inteiro, com comentários em geral, e o segundo módulo é o production, onde vai minificar nosso código, deixando mais performático
    entry: './src/index.js', //Arquivo de entra 
    output: {
